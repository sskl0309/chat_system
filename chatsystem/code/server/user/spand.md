...
3. 邮箱验证码获取：当用户通过邮箱注册或登录的时候，需要获取邮箱验证码
4. 邮箱注册：用户输入邮箱和邮箱验证码进行邮箱的用户注册
5. 邮箱登录：用户输入邮箱和邮箱验证码进行邮箱的用户登录
...
5. redis 客户端模块：基于 redis++ 封装的客户端进行内存数据库数据操作
   ...
   - 当用户邮箱进行获取/验证验证码的时候，验证码与对应信息保存在 redis 服务器中。
...
9. 邮件平台客户端模块：基于邮件平台 SDK 封装使用，用于向用户邮箱发送指定验证码。
...
用户信息的用户 ID，邮箱，昵称字段需要在 ES 服务器额外进行一份存储，其目的是因为有用户搜索的功能，用户搜索通常会是一种字符串的模糊匹配方式，用传统的关系型数据库进行模糊匹配效率会极差，因此采用 ES 服务对索引字段进行分词后构建倒排索引，根据关键词进行搜索，效率会大大提升。
...
{"index":{"_id":"1"}}
{"user_id" : "USER4b862aaa-2df8654a-7eb4bb65-e3507f66","nickname" : "昵称 1","email" : "邮箱 1","description" : "签名 1","avatar_id" : "头像 1"}
{"index":{"_id":"2"}}
{"user_id" : "USER14eeeea5-442771b9-0262e455-e4663d1d","nickname" : "昵称 2","email" : "邮箱 2","description" : "签名 2","avatar_id" : "头像 2"}
{"index":{"_id":"3"}}
{"user_id" : "USER484a6734-03a124f0-996c169d-d05c1869","nickname" : "昵称 3","email" : "邮箱 3","description" : "签名 3","avatar_id" : "头像 3"}
{"index":{"_id":"4"}}
{"user_id" : "USER186ade83-4460d4a6-8c08068f-83127b5d","nickname" : "昵称 4","email" : "邮箱 4","description" : "签名 4","avatar_id" : "头像 4"}
{"index":{"_id":"5"}}
{"user_id" : "USER6f19d074-c33891cf-23bf5a83-57189a19","nickname" : "昵称 5","email" : "邮箱 5","description" : "签名 5","avatar_id" : "头像 5"}
{"index":{"_id":"6"}}
{"user_id" : "USER97605c64-9833ebb7-d0455353-35a59195","nickname" : "昵称 6","email" : "邮箱 6","description" : "签名 6","avatar_id" : "头像 6"}
```

...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[3UL])
    {
      i._passwd_value.capacity (i._passwd_size);
      grew = true;
    }
    ...
    if (t[5UL])
    {
      i._email_value.capacity (i._email_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i._passwd_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i._passwd_value.capacity ());
    b[n].length = &i._passwd_size;
    b[n].is_null = &i._passwd_null;
    n++;
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i._email_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i._email_value.capacity ());
    b[n].length = &i._email_size;
    b[n].is_null = &i._email_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (true);
      std::size_t size (0);
      std::size_t cap (i._passwd_value.capacity ());
      mysql::value_traits<
          ::odb::nullable< ::std::basic_string< char > >,
          mysql::id_string >::set_image (
        i._passwd_value,
        ...
        is_null,
        v);
      i._passwd_null = is_null;
      i._passwd_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i._passwd_value.capacity ());
    }
    ...
    //
    {
      ...
      bool is_null (true);
      std::size_t size (0);
      std::size_t cap (i._email_value.capacity ());
      mysql::value_traits<
          ::odb::nullable< ::std::basic_string< char > >,
          mysql::id_string >::set_image (
        i._email_value,
        ...
        is_null,
        v);
      i._email_null = is_null;
      i._email_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i._email_value.capacity ());
    }
